...
| [[fig:sim-asymptotics]]                    | [[file:./R/postprocess-scenario-3-part-i.R]] |
...
#+caption: A visualisation of the relationship between error and uncertainty, and the size of the dataset used to generate the estimate.
#+name: fig:sim-asymptotics
#+attr_org: :width 500px
#+attr_html: :width 400px
[[./out/s3/plots/summary-est-vs-size.png]]
