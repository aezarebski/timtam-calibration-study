...
summary_list <- map(seq.int(num_replicates), \(ix) make_summary(read_mcmc_modified(str_interp("out/s3/timtam-scenario-3-2-sample-$[03d]{ix}.log")), ix))
...
my_ggsave(
  filename = "out/s3/plots/effective-sample-sizes-s-3-2.png",
  plot = ess_gg,
