...
occurrence_files <- list.files("out/s2", pattern = ".*ssv", full.names = TRUE)
sequence_files <- list.files("out/s2", pattern = ".*fasta", full.names = TRUE)
...
ggsave(filename = "out/s2/plots/dataset-size-1.png",
       plot = data_size_1_gg,
...
ggsave(filename = "out/s2/plots/dataset-size-2.png",
       plot = data_size_2_gg,
